...
-- AddForeignKey
ALTER TABLE "Learner" ADD CONSTRAINT "Learner_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "Parent"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_hodId_fkey" FOREIGN KEY ("hodId") REFERENCES "Teacher"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_admissionNumber_fkey" FOREIGN KEY ("admissionNumber") REFERENCES "Learner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Attendance" ADD CONSTRAINT "Attendance_admissionNumber_fkey" FOREIGN KEY ("admissionNumber") REFERENCES "Learner"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
